...
There are a couple of [additional overlays](https://github.com/goong-io/goong-map-react/tree/main/examples/additional-overlays) in the examples folder that can be copied into applications `ScatterplotOverlay`, `ChoroplethOverlay`.
